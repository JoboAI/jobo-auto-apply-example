...
/**
 * RESTRICT_APPLY_HOSTS is what makes a shared deployment safe to hand out:
 * without it, whoever opens the page can point this app at any employer's form
 * and a real application is submitted under the deployment's API key.
 *
...
describe('RESTRICT_APPLY_HOSTS', () => {
  ...
  it('is off by default, so local use is unaffected', async () => {
    ...
    // module reload.
    process.env.RESTRICT_APPLY_HOSTS = 'false'
